...
const config = {
  ...
  options: {
    encrypt: false, // For Azure SQL Database, this should be true. For local SQL Server, often false. sử dụng local
    trustServerCertificate: true, // Change to true for local dev / self-signed certs sử dụng local
  },
};
