...
const {
  getUserByRole,
  getUserByUserId,
} = require("../Controller/Infomation/getUser");
const {
  createStudentInformation,
  updateStudentInfoById,
} = require("../Controller/Infomation/createStudentInfo");
const {
  adminUpdateUserById,
  deleteAccountById,
} = require("../Controller/Login/account_status");

const adminRouter = express.Router();

adminRouter.post(
  "/register",
  validateInput(Schemas, "Information"),
  registerController
);
...
adminRouter.post(
  "/student/create",
  validateInput(Schemas, "StudentInformation"),
  createStudentInformation
);
