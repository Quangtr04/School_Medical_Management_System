...

    {
      ...
      render: () => (
        <div className="flex justify-center space-x-2">
          ...
          <Tooltip title="Xóa">
            <Button type="default" danger icon={<FaTrashAlt />} size="small" />
          </Tooltip>
        </div>
      ),
    },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10 text-gray-800">
          ...
          <div className="flex items-start gap-3 bg-gray-50 p-3 rounded-lg">
            ...
            <div>
              ...
              <p className="text-base font-semibold">{student.gender}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 bg-gray-50 p-3 rounded-lg">
            ...
            <div>
              ...
              <p className="text-base font-semibold">{student.address}</p>
            </div>
          </div>
