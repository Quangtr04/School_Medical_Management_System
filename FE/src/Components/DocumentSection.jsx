    ...
    <section id="documents-section" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4" style={{ fontWeight: 600 }}>
          ...
          {documentCategories.map((category, index) => (
            <div key={index} className="bg-white rounded-lg shadow-sm p-6">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-900" style={{ fontWeight: 600 }}>
                  {category.title}
                </h3>
              </div>
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex items-start">
                        ...
                        >
                          <h4 className="font-medium text-gray-900 mb-1 hover:text-blue-600 transition-colors" style={{ fontWeight: 600 }}>
                            {doc.name}
                          </h4>
