...
export default function Examination() {
  ...
  console.log(upcomingExaminations);
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "scheduled_date",
      render: (date) => (date ? format(parseISO(date), "yyyy-MM-dd") : "Không có"),
      className: "!font-semibold !text-gray-700",
    },
    {
      title: (
      ...
      className: "!font-semibold !text-gray-700",
      render: (created_at) =>
        created_at ? format(parseISO(created_at), "yyyy-MM-dd") : "Không có",
    },
    {
      title: (
        <Space>
              ...
              onClick={async () => {
                if (record.approval_status === "APPROVED") {
                  ...
                  try {
                   ...
                   message.error(err || "Tải danh sách học sinh thất bại.");
                  }
                } else {
                 message.warning("Đơn khám này chưa được duyệt.");
                }
              }}
            />
          </Tooltip>
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <Modal
          title={
            currentExamination
              ? <span>✏️ Chỉnh sửa đơn khám sức khỏe</span>
              : <span>📝 Tạo đơn khám sức khỏe định kỳ mới</span>
          }
          open={isModalVisible}
        ...
        >
          ...
          >
            <Form.Item
              name="title"
              label={<span>🏷️ Tiêu đề đơn khám</span>}
              rules={[{ required: true, message: "Vui lòng nhập tiêu đề đơn khám!" }]}
            >
              <Input placeholder="Nhập tiêu đề đơn khám" />
            </Form.Item>
            <Form.Item
              name="description"
            ...
            >
              <TextArea rows={3} placeholder="Mô tả nội dung đơn khám" />
            </Form.Item>

            <Form.Item
              name="scheduled_date"
              label={<span>📅 Ngày lên lịch khám</span>}
              rules={[
                {
                  required: true,
            ...
            >
              <DatePicker style={{ width: "100%" }} format="YYYY-MM-DD" placeholder="Chọn ngày khám" />
            </Form.Item>
            ...
            <Table
              ...
              columns={[
                ...
                },
                {
                  ...
                  key: "dob",
                  render: (dob) =>
                    dob ? format(parseISO(dob), "dd/MM/yyyy") : "Không có",
                },
                {
                  title: (
                    <span className="flex items-center gap-1">
