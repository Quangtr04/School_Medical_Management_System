...
export default function ParentSideBar() {
  const menuItems = [
    ...
    {
      key: "/parent/appointment-request",
      icon: <CalendarOutlined />,
      label: <Link to="/parent/appointment-request">Đặt lịch hẹn</Link>,
    },
    {
      key: "/parent/support-request",
      icon: <QuestionCircleOutlined />,
      label: <Link to="/parent/support-request">Hỗ trợ</Link>,
    },
  ];
  return (
    <Sider
